...
.custom-menu .ant-menu-item-selected {
  color:rgb(21, 142, 218) !important;
  border-bottom: 3px solid rgb(118, 195, 243);
  font-weight: 700;
  background-color: transparent !important;
}
...
.usericon p {
  ...
  max-width: 100px;
    ...
    input {
      border-radius: 25px;
      border: ${({ theme }) =>
        theme === "dark" ? "1px solid #A2A1A1" : "1px solid #f3f2f2"};
